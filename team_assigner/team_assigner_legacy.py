"""Frozen snapshot of TeamAssigner before the color_extractor.py rewrite — used only by scripts/benchmark_detection.py for before/after comparison. Not used by main.py."""
